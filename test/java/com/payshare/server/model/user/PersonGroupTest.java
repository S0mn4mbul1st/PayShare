...
public class PersonGroupTest {
        ...
        public void testBalanceAfterAddExpense() {
                ...
                assertAll(
                                ...
                                () -> assertThat(henryMember.getBalances().get(euro))
                                                .isEqualTo(BigDecimal.valueOf(-20).setScale(2, RoundingMode.HALF_UP)),
                                () -> assertThat(holidays.getMembers().stream().map(x -> x.getBalances().get(euro))
        ...
        public void testBalanceAfterAddExpenseWithDifferentWeightsAndWithoutOneMember() {
                ...
                assertAll(
                                () -> assertThat(johnMember.getBalances().get(euro))
                                                .isEqualTo(BigDecimal.valueOf(6 - 2.57).setScale(2,
        ...
        public void testGetSettleUpExpenses() {
                ...
                GroupExpense johnToJanetActualExpense = expensesToSettleUp.stream()
                                ...
                                .findFirst()
                                .get();
                assertAll(() -> assertThat(johnToHenryActualExpense.getCurrency())
                                .isEqualTo(johnToHenryExpectedExpense.getCurrency()),
                                () -> assertThat(johnToHenryActualExpense.getAmount())
                                                .isEqualTo(johnToHenryExpectedExpense.getAmount()),
                                () -> assertThat(johnToHenryActualExpense.getCreditor())
                                                .isEqualTo(johnToHenryExpectedExpense.getCreditor()),
                                () -> assertThat(johnToHenryActualExpense.getPersonGroupExpenses())
                                                .hasSameSizeAs(johnToHenryExpectedExpense.getPersonGroupExpenses()),

                                () -> assertThat(johnToJanetActualExpense.getCurrency())
                                                .isEqualTo(johnToJanetExpectedExpense.getCurrency()),
                                () -> assertThat(johnToJanetActualExpense.getAmount())
                                                .isEqualTo(johnToJanetExpectedExpense.getAmount()),
                                () -> assertThat(johnToJanetActualExpense.getCreditor())
                                                .isEqualTo(johnToJanetExpectedExpense.getCreditor()),
                                () -> assertThat(johnToJanetActualExpense.getPersonGroupExpenses())
                                                .hasSameSizeAs(johnToJanetExpectedExpense.getPersonGroupExpenses()));
        }
}

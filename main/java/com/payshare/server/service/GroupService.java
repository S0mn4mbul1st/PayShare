...
import com.payshare.server.dto.expense.scheduled.group.ScheduledExpenseParticipantCreateDto;
import com.payshare.server.dto.expense.scheduled.group.ScheduledGroupExpenseCreateDto;
import com.payshare.server.dto.group.ExpenseParticipantCreateDto;
import com.payshare.server.dto.group.GroupCreateDto;
...
import com.payshare.server.model.expense.scheduled.FrequencyUnit;
...
import com.payshare.server.repository.*;
...
public class GroupService {
    ...
    public void addExpense(Long groupId, GroupExpenseCreateDto expenseDto, Person issuer)
        ...
        for (Map.Entry<Currency, BigDecimal> balance : membership.getBalances().entrySet()) {
            if (balance.getValue().compareTo(BigDecimal.ZERO) > 0) {
                ...
                notificationRecipients.addAll(membership.getGroup().getMembers()
                        ...
                        .filter(personGroup -> personGroup.getBalances().get(balance.getKey())

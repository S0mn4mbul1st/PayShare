...
import com.payshare.server.dto.PersonReadDto;
...
import com.payshare.server.service.PersonService;
...
public class PersonController {
    ...
    private PersonReadDto assembleLinks(Authentication authentication, Person person) {
        ...
        Link userAccountLink = linkTo(methodOn(UserAccountController.class).getUserAccount(authentication))
                .withRel("userAccount");
        Link friendshipsLink = linkTo(methodOn(FriendshipController.class).getAllFriendships(authentication))
                .withRel("friendships");

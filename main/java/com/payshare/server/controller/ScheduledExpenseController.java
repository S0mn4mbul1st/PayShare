...
import com.payshare.server.dto.expense.scheduled.ScheduledExpenseReadDto;
import com.payshare.server.dto.expense.scheduled.own.ScheduledOwnExpenseCreateDto;
...
import com.payshare.server.service.ScheduledExpenseService;
...
public class ScheduledExpenseController {
    ...
    public ResponseEntity<?> getAllScheduledExpenses(Authentication authentication) {
        try {
            ...
            List<ScheduledGroupExpense> scheduledGroupExpenses = scheduledExpenseService
                    .getAllScheduledGroupExpenses(person);
            List<ScheduledOwnExpense> scheduledOwnExpenses = scheduledExpenseService.getAllScheduledOwnExpenses(person);
